...
const WorkflowTemplateModal: React.FC<WorkflowTemplateModalProps> = ({
  ...
  const categories: string[] = ['All', ...Array.from(new Set((templates as WorkflowTemplate[]).map((t: WorkflowTemplate): string => t.category)))];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {Object.entries(previewTemplate.agentPrompts).map(([agentName, prompt]: [string, string]) => (

...
import { AgentPrompts, ModelProvider, AgentName } from '../types';
...
const BUILT_IN_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    version: '2.1',
    agentPrompts: {
      [AgentName.SEARCH]: `You are a specialist Research Agent with expertise in [YOUR_FIELD]. Your goal is to conduct a comprehensive literature review on the user-provided topic with a focus on recent developments and emerging trends.
...
4. Citation list with DOIs`,
      [AgentName.LEARNINGS]: `You are an expert Analyst Agent specializing in evidence-based analysis and critical evaluation. Your task is to generate a comprehensive, evidence-based analysis that follows academic standards.
...
Structure your analysis with clear headings and include confidence levels for each major claim.`,
      [AgentName.OPPORTUNITY_ANALYSIS]: `You are a meticulous Critical Evaluator Agent. Your role is to scrutinize the provided analysis.
...
{generatedAnalysis}
---`,
      [AgentName.PROPOSER]: `You are an Academic Research Proposal Agent. Based on the literature review, analysis, and critique, your job is to propose a new research project.
...
{tool_results}
---`,
      [AgentName.AGGREGATOR]: `You are an Academic Research Synthesizer Agent. Your final task is to create a comprehensive academic research proposal.
...
---`
  ...
  },
  {
    ...
    version: '1.8',
    agentPrompts: {
      [AgentName.SEARCH]: `You are a Technical Research Agent. Your goal is to conduct a focused technical literature review on the user-provided topic.
...
{tool_results}`,
      [AgentName.LEARNINGS]: `You are a Technical Analyst Agent. Your task is to generate a comprehensive technical analysis of the given topic.
...
---
Feedback from previous iteration: {feedback}`,
      [AgentName.OPPORTUNITY_ANALYSIS]: `You are a Technical Evaluator Agent. Your role is to scrutinize the provided technical analysis.
...
{generatedAnalysis}
---`,
      [AgentName.PROPOSER]: `You are a Technical Solution Proposer Agent. Based on the technical analysis and critique, your job is to propose a technical solution or improvement.
...
{tool_results}
---`,
      [AgentName.AGGREGATOR]: `You are a Technical Documentation Synthesizer Agent. Your final task is to create comprehensive technical documentation.

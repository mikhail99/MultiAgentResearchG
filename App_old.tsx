...
export default function App() {
  ...
  const [enableArxivSearch, setEnableArxivSearch] = useState<boolean>(true);
        ...
        if (toolServiceAvailable) {
          ...
          try {
            ...
            setToolResults({
              ...
              arxivResults: results.arxivResults,
            ...
            console.log('🔧 Tool results received:', {
              ...
              hasArxivResults: !!results.arxivResults,
              webResultsLength: results.webResults?.length || 0,
              arxivResultsLength: results.arxivResults?.length || 0,
      ...
      if (shouldRunStep(ProcessStatus.CHECKING_NOVELTY)) {
        ...
        if (toolServiceAvailable) {
          ...
          try {
            ...
            // Format for prompt
            noveltyToolData = formatToolResultsForPrompt(results.webResults, results.arxivResults);
          ...
          <main className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-3 space-y-6">
               <ControlPanel
                  ...
                  enableArxivSearch={enableArxivSearch}
                  setEnableArxivSearch={setEnableArxivSearch}
